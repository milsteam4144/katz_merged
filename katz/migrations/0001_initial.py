# Generated by Django 4.1.5 on 2023-04-02 21:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('catID', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, to='katz.cat')),
                ('customerID', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, to='katz.customer')),
            ],
        ),
        migrations.CreateModel(
            name='User',
