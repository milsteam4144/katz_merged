...
from .models import CatTest, Transaction, Breeder
...
def cat_register(request):
    if request.method == 'POST' and request.FILES['image']:
        ...
        #This is hard-coded for testing purposes. For now, the breeder object with id 35 will be used for every cat
